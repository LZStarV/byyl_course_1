...
HomePage::HomePage(QWidget* parent) : QWidget(parent)
{
    ...
    QFont f1 = lblTitle->font(); f1.setPointSize(f1.pointSize() + 8); f1.setBold(true);
    lblTitle->setFont(f1);
    ...
    QFont fti = authTitle->font(); fti.setBold(true);
    authTitle->setFont(fti); stuTitle->setFont(fti);
    QFont fval = lblAuthor->font(); fval.setPointSize(fval.pointSize() + 2);
    lblAuthor->setFont(fval); lblStuId->setFont(fval);

   ...
   private slots:
    void full_tree_contains_expected_nodes()
    {
        ...
        QVector<QString> tokens = {
            "read",       "identifier", ";",          "if",         "number", "<",
            "identifier", "then",       "identifier", ":=",         "number", ";",
            "repeat",     "identifier", ":=",         "identifier", "*",      "identifier",
            ";",          "identifier", ":=",         "identifier", "-",      "number",
            "until",      "identifier", "=",          "number",     ";",      "write",
            "identifier", "end"};
        ...
        acts[QStringLiteral("statement")]     = {QVector<int>({1}),
                                                 QVector<int>({1}),
                                                 QVector<int>({1}),
                                                 QVector<int>({1}),
                                                 QVector<int>({1})};
        ...
        acts[QStringLiteral("if-stmt")]       = {QVector<int>({1, 2, 0, 2, 0}),
                                                 QVector<int>({1, 2, 0, 2, 0, 2, 0})};
        acts[QStringLiteral("exp")]           = {QVector<int>({2, 1, 2}), QVector<int>({1})};
        acts[QStringLiteral("comparison-op")] = {QVector<int>({1}),
                                                 QVector<int>({1}),
                                                 QVector<int>({1}),
                                                 QVector<int>({1}),
                                                 QVector<int>({1}),
        ...
        acts[QStringLiteral("mulop")]         = {
            QVector<int>({1}), QVector<int>({1}), QVector<int>({1}), QVector<int>({1})};
        ...
        QVERIFY(findTag(res.astRoot, QStringLiteral("identifier(x)")));
        QVERIFY(findTag(res.astRoot, QStringLiteral("identifier(fact)")));
        QVERIFY(findTag(res.astRoot, QStringLiteral("number(1)")));
    }
};
